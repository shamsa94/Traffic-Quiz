...
public class StartQuiz extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set an event handler for the "Next" button
        Button myButton = (Button) findViewById(R.id.next02);
        myButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                //Test if the user has selected any answer or not ?
                ...
                //The user has selected an answer so we must update the answers array according to the answer !
                ...
                //If the button "correctAns" is checked then it's a correct answer !
                ...
                //Is the questions bank array empty ?
                if (activityList.size() == 0) {
                    ...
                    //We still have more questions so select a random one and view it
